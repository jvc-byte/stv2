        ...
        <footer className=" p-6 bg-teal-200 ">
            <div className="footer text-base-content p-10 border-b border-gray-500">
                <div>
                    ...
                    <p className="footer-title">Connect with us and make a SealedTrust</p>
                    <div className=" sm:w-full flex items-center justify-evenly gap-1 sm:gap-2 mb-4">
                        <Link href={"#facebook"}
                            className="w-8 h-8 flex items-center justify-center rounded-lg bg-white shadow-gray-200 group transition-all duration-300">
                    ...
                    <form className="w-full max-w-md">
                        ...
                        <fieldset className="form-control w-full">
                            ...
                            <div className="join flex-col sm:flex-row w-full gap-2 sm:gap-0">
                                ...
                                />
                                <button className="btn btn-success sm:join-item relative overflow-hidden group w-full sm:w-auto">
                ...
                <nav>
                    ...
                    <Link href={"#"} className="link link-hover">Vehicle Escrow</Link>
                    <Link href={"#"} className="link link-hover">Domain and Website Escrow</Link>
                    <Link href={"#"} className="link link-hover">Domain Name Holding Escrow</Link>
                    <Link href={"#"} className="link link-hover">General Machandise Escrow</Link>
                    <Link href={"#"} className="link link-hover">Milestone Escrow</Link>
                    <Link href={"#"} className="link link-hover line-through">Broker Escrow</Link>
                    <Link href={"#"} className="link link-hover line-through">IPv4 Escrow</Link>
                    <Link href={"#"} className="link link-hover line-through">PPE Escrow</Link>
                    <Link href={"#"} className="link link-hover">Art Escrow</Link>
                </nav>
                <nav>
                    <h6 className="footer-title">Support</h6>
                    <Link href={"#"} className="link link-hover">Free Calculator</Link>
                    <Link href={"#"} className="link link-hover">Payment Options</Link>
                    <Link href={"#"} className="link link-hover">Approved Carriers</Link>
                    <Link href={"#"} className="link link-hover">Security</Link>
                    <Link href={"#"} className="link link-hover">Fraud Prevention</Link>
                    <Link href={"#"} className="link link-hover">Common Questions</Link>
                    <Link href={"#"} className="link link-hover">Report a Bug</Link>
                </nav>
                <nav>
                ...
                <nav className="flex flex-col gap-2">
                    ...
                    <Link href={"#"} className="link link-hover">Get Started</Link>
                    <Link href={"#"} className="link link-hover">Our Partners</Link>
                    <Link href={"#"} className="link link-hover">Partner Enquiry</Link>
                    <Link href={"#"} className="link link-hover">API Guide</Link>
                </nav>
            </div>
